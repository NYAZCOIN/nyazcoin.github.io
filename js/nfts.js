        ...
        card.addEventListener('click', () => {
            ...
            modal.innerHTML = `
                <div style="background: #0a0a1a; border: 1px solid rgba(153, 69, 255, 0.3); border-radius: 15px; padding: 30px; max-width: 500px; width: 90%; text-align: center;">
                    ...
                    <button class="btn btn-secondary" style="margin-top: 10px; pointer-events: none; opacity: 0.6;">Mint NFT (Coming Soon)</button>
                    <!-- To enable minting, uncomment the following line: -->
                    <!-- <button class="btn btn-secondary" style="margin-top: 10px;" id="mint-nft">Mint NFT</button> -->
                </div>
            `;
            ...
            // Mint NFT functionality (disabled)
            // document.getElementById('mint-nft')?.addEventListener('click', () => {
            //     alert('NFT minting functionality will be enabled soon!');
            // });
        });
    });
});
